...
CREATE TABLE IF NOT EXISTS users (
    ...
    username            varchar(30)    CONSTRAINT user_public_id UNIQUE NOT NULL,
...
CREATE TYPE load_type_enum AS ENUM ('distance', 'weight');
CREATE TYPE rest_type_enum AS ENUM ('optional', 'beforeCount', 'afterCount');

CREATE TABLE IF NOT EXISTS exercise_types (
    id                 int                 GENERATED ALWAYS AS IDENTITY PRIMARY KEY,
    exercise_type_name varchar(255)        CONSTRAINT exercise_type_public_id UNIQUE NOT NULL,
...
CREATE TABLE IF NOT EXISTS exercises (
    id            int          GENERATED ALWAYS AS IDENTITY PRIMARY KEY,
    exercise_name varchar(255) CONSTRAINT exercise_public_id UNIQUE NOT NULL,
    description   text,
    exercise_type int          REFERENCES exercise_types NOT NULL
);
...
CREATE TABLE IF NOT EXISTS user_exercise_statistics (
    user_exercise_id int      REFERENCES user_exercises NOT NULL,
